...
class BannerScrollPhysics extends ScrollPhysics {
    final double itemDimension;

    BannerScrollPhysics({this.itemDimension, ScrollPhysics parent})
        : super(parent: parent);

    @override
    BannerScrollPhysics applyTo(ScrollPhysics ancestor) {
        return BannerScrollPhysics(
