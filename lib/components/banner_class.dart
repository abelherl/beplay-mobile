...
//      ..elevation(pressed ? 0 : 15, opacity: 0.8)
        ...
        ..background.image(url: "https://images.pexels.com/photos/163403/box-sport-men-training-163403.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", fit: BoxFit.cover)
        ..borderRadius(all: 20),
      child: Container(
